...
#std.all is the much of affetc of each variabel on the outcome
#varainces = 1 - varaince = R-sqr==> 1-0.813 = 0.187
#define parameter is related to direct and indirect effects and the total 
```
